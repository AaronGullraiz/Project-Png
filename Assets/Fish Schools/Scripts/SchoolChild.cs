...
public class SchoolChild:MonoBehaviour{
	...
	bool _scan = true;
	bool _instantiated = true;	//Has this been instantiated
	...
	public void CheckForBubblesThenInvoke() {
		if(_spawner !=null && _spawner._bubbles != null)
	...
	public void RandomizeStartAnimationFrame(){
		if (_model && _model.GetComponent<Animation>())
		{
